...
import {changePage} from "../../redux/actionsCreator";
class LeftMenu extends React.Component{
    render() {
        return(
            <div className={styles.wrapper}>
                <div className={styles.menu}>
                    <div className={styles.menuItem} onClick={this.props.changePage.bind(null, 'home')}>
                    ...
                    <div className={styles.menuItem} onClick={this.props.changePage.bind(null, 'archive')}>
                        <svg className={styles.svg}>
                    ...
                    <div className={styles.menuItem} onClick={this.props.changePage.bind(null, 'trash')}>
                        <svg className={styles.svg}>
